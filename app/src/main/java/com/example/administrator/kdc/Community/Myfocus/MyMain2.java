...
public class MyMain2 extends AppCompatActivity {

    List<Fragment> fragmentList = new ArrayList<Fragment>();
    ViewPager vp;
    RadioGroup radioGroup;
    static MyAllFriend_Fragment myallPost_fragment = new MyAllFriend_Fragment();
    ...
    @OnClick(R.id.return_community_mainlayout)//返回主界面
    public void onClick() {
        finish();
    }
