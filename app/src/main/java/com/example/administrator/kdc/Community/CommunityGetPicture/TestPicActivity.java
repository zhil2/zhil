package com.example.administrator.kdc.Community.CommunityGetPicture;//相册
...
public class TestPicActivity extends Activity implements View.OnClickListener{//相册
