 ...
 * 
 */
public class AlbumHelper{//专辑帮助类
	 ...
	 * 得到图片集
	 * 出现问题，当新增图片库时，图库中无图片
	 * 当删除图片库是时，图库中仍出现该图库，但无图片
	 * @param refresh
	 * @return
	 */
	public List<ImageBucket> getImagesBucketList(boolean refresh) {
		if (refresh || (!refresh && !hasBuildImagesBucketList)) {//在app活动过程中只出现一次
