package com.example.administrator.kdc.wheelview;
...
public class WheelMain {
    ...
    public void initDateTimePicker2(int h, int m) {
    ...
    public String getTime2() {
        ...
        if (!hasSelectTime) {
            sb.append("").append(strHour).append(":").append(strMin);
    ...
    public void initDateTimePicker(int year, int month, int day, int h, int m) {
        ...
        wv_year.setAdapter(new NumericWheelAdapter(
                START_YEAR, END_YEAR));
        wv_year.setCyclic(false);// 是否可循环滚动
