...
//       venuesDetail=new Venues_tbl(1,"name",1,1,new Address_tbl("江苏省","苏州市",1,"吴中区","文荟","高博"),new Venuesshow_tbl(2,2,2,"a",2.0,"a"),1,1,1);
        ...
        // eachPrice= Double.parseDouble(etPrice.getText().toString());
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_send:
                ...
                Totalprice=Integer.parseInt(etEnd.getText().toString())*eachPrice;
            ...
            case R.id.et_start:
                ...
                TimePickerDialog time = new TimePickerDialog(OrderActivity2.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                DatePickerDialog datePicker = new DatePickerDialog(OrderActivity2.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        //      Log.d("time","time"+y + "-" + m3 + "-" + d2 + " " + h+ ":" + m+":00");
